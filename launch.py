...
app = modal.App(
    ...
    image=modal.Image.from_gcp_artifact_registry("us-central1-docker.pkg.dev/tour-project-442218/tour-docker-repo/colmap:3.8", secret=modal.Secret.from_name("gcp-credentials"), add_python="3.10")
    # SSH server
